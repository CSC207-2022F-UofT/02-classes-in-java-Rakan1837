...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly Object
     * This consturctor takes in two strings as arguments
     * @param first a string for Silly's first name
     * @param other a string for Silly's second name
     */
    public Silly(String first, String other) {this.name = first + other;}
